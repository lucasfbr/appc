...
<section id="contato" class="div_colorida" ng-controller="inicialController">
    ...
    <input type="hidden" name="alert-hiden" id="alert-hiden" value="">
    <div class="modal fade" tabindex="-1" role="dialog" id="myModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><strong>Formulário de Contato</strong></h4>
                </div>
...
<?php echo $__env->make('layouts.singlePage', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>