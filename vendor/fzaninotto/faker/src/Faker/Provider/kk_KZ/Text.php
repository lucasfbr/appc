...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    License. If You create a Collection, upon post from any Licensor You
    must, to the extent practicable, remove from the Collection any credit
    as required by Section 4(c), as requested. If You create an
    Adaptation, upon post from any Licensor You must, to the extent
    ...
    Parties") in Licensor's copyright post, terms of service or by other
    ...
    unless such URI does not refer to the copyright post or licensing
